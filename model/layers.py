...
class UpSampleConcat(tf.keras.Model):

    def __init__(self, filters=1, kernel_size=3, momentum=0.99, strides=2, dropout=0.0,
                 activation=tf.keras.activations.relu, apply_bn=True, regularizer=None):
...
class UpSample(tf.keras.Model):
    ...
    def __init__(self, filters=1, kernel_size=3, momentum=0.99, strides=2, dropout=None,
                 activation=tf.nn.relu, apply_bn=True, regularizer=None):
