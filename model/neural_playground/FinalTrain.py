...
import os
from model.neural_playground.FinalNetwork import *
...
log_directory = '../../logs/FinalNetwork/'
...
network = FinalNetwork(checkpoint_directory=checkpoint_directory, input_dims=(320, 240))

model = FinalModel(learning_rate=lr, network=network)
